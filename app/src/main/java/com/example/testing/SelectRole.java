...
public class SelectRole extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnChangeToEs = findViewById(R.id.btnSpain);
...
//        click button VN
        ...
        //click button ES
        btnChangeToEs.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                languageManager.setCurrentLanguageCode("es");
                setLanguage("es");
                recreate();
            }
        });
...
//                }
                ...
                Intent loginIntent;
                if ("Giáo viên".equals(selectedRole) ||("Teacher".equals(selectedRole) ||("Profesor".equals(selectedRole)))) {
                    loginIntent = new Intent(SelectRole.this, TeacherLogin.class);
                } else if ("Học sinh".equals(selectedRole) || "Student".equals(selectedRole) || "Estudiante".equals(selectedRole)){
